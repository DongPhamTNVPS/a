package com.dong_pham.trafficsignrecognition.ml;
...
public final class ModelUnquant {
  @NonNull
  private final Model model;

  private ModelUnquant(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "model_unquant.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelUnquant newInstance(@NonNull Context context) throws IOException {
    return new ModelUnquant(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelUnquant newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new ModelUnquant(context, options);
  }
